...
public class ContatoController {
	...
	// No curso pede para utilizar o PutMapping, mas não funciona!
	// Deixar em PostMapping que os dados serão salvos sem problemas.
	...
	// Métodos auxiliares devem ser private
	// Uma vez que serão utilizados apenas para auxiliar métodos principais
